"""
Service infrastructure: configuration, circuit breaker, and concurrency management.

Centralised infrastructure components extracted from the API layer so they can
be reused across route handlers and service classes without circular imports.
"""
...
class ServiceConfig:
    """Centralised performance and resource configuration.

    All tunable parameters for concurrency, timeouts, caching,
    rate limiting, and health monitoring live here.
    """
...
class CircuitBreaker:
    ...
    service is struggling, and automatically attempts recovery.
    """
    ...
    def is_available(self) -> bool:
        """Check whether the circuit allows requests."""
        ...
        return True  # HALF_OPEN allows a test request
...
class ConcurrencyManager:
    """Manages request concurrency with semaphore-based limits."""
    ...
    async def request_limit(self, request_id: str):
        """Context manager for request concurrency limiting."""
    ...
    async def pdf_limit(self):
        """Context manager for PDF parsing concurrency limiting."""
